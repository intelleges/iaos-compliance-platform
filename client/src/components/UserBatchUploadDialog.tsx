/**
 * User Batch Upload Dialog
 * INT.DOC.64 Section 3 - User Batch Load
 * 
 * 3-step wizard for bulk user import:
...
interface UserBatchUploadDialogProps {
  open: boolean;
...
export function UserBatchUploadDialog({
  open,
  onOpenChange,
  onSuccess,
}: UserBatchUploadDialogProps) {
  ...
  const validateMutation = trpc.userBatch.validate.useMutation();
  const uploadMutation = trpc.userBatch.upload.useMutation();
    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Bulk import enterprise users from Excel template (INT.DOC.64 Section 3)
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <p className="text-lg font-medium mb-2">
                {file ? file.name : 'Drop your User Load Template here'}
              </p>
            ...
            <div className="p-4 bg-gray-50 rounded-lg border">
              ...
              <p className="text-xs text-gray-600">
                Email, First Name, Last Name, Role, Title, Department, Phone, Is Active, Groups, SSO ID
              </p>
            </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-green-700">
                      All {validationResult.summary.validRows} users are ready to import
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="space-y-4">
            <div className="p-6 bg-green-50 rounded-lg border border-green-200 text-center">
              ...
              <p className="text-green-700">
                Successfully processed {importResult.summary.totalProcessed} users
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="p-4 bg-green-50 rounded-lg border border-green-200">
                <p className="text-sm text-green-700">Reactivated</p>
                <p className="text-2xl font-bold text-green-900">
                  {importResult.summary.reactivated}
                </p>
              </div>
            </div>
              ...
              <div className="max-h-48 overflow-y-auto border rounded-lg">
                ...
                <div className="divide-y">
                  {importResult.errors.map((error: any, idx: number) => (
                    <div key={idx} className="px-4 py-3">
                      <p className="font-medium text-red-900">
                        Row {error.rowNumber}: {error.userId}
                      </p>
