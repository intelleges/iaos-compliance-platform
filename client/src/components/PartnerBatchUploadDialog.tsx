            ...
            <Alert>
              ...
              <AlertDescription>
                ...
                <ul className="list-disc list-inside mt-2 text-sm">
                  <li>23 columns: Partner ID, Name, DUNS, Contact Info, Address</li>
                  <li>Required fields: PARTNER_INTERNAL_ID, PARTNER_NAME, PARTNER_POC_EMAIL_ADDRESS</li>
                  <li>Download template from Admin Portal → Data Management → Templates</li>
                </ul>
              </AlertDescription>
            </Alert>
          </div>
